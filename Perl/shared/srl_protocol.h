...
#define SRL_HDR_RESERVED_HIGH   ((char)54)

#define SRL_HDR_POS_VARINT      ((char)55)      /* <VARINT> - Positive varint, n =  ( varint + 16 ) */
#define SRL_HDR_NEG_VARINT      ((char)56)      /* <VARINT> - Negative varint, n = -( varint + 17 ) */
