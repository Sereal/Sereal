    ...
    if (opt != NULL) {
        ...
        if (svp) {
            ...
            case 1:
                ...
                break;
            case 2:
                SRL_ENC_SET_OPTION(enc, SRL_F_COMPRESS_LZ4);
                break;
            case 3:
                SRL_ENC_SET_OPTION(enc, SRL_F_COMPRESS_LZ4_HC);
                break;
            default:
...
/* Resets the compression header flags to OFF.
            ...
            && uncompressed_body_length < (STRLEN)enc->compress_threshold)
        {
            ...
            dest_len = sereal_header_len + 1
                        + ( is_snappy ? (size_t)csnappy_max_compressed_length(uncompressed_body_length)
                                      : (size_t)LZ4_compressBound(uncompressed_body_length) );
