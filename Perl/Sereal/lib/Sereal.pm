...
use strict;
use warnings;
our $VERSION = '4.000_001';
our $XS_VERSION = $VERSION; $VERSION= eval $VERSION;
use Sereal::Encoder 4.000_001 qw(encode_sereal sereal_encode_with_object);
use Sereal::Decoder 4.000_001 qw(decode_sereal looks_like_sereal sereal_decode_with_object);
