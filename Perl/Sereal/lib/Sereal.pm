...
use strict;
use warnings;
our $VERSION = '3.005_005';
our $XS_VERSION = $VERSION; $VERSION= eval $VERSION;
use Sereal::Encoder 3.005_005 qw(encode_sereal sereal_encode_with_object);
use Sereal::Decoder 3.005_005 qw(decode_sereal looks_like_sereal sereal_decode_with_object);
