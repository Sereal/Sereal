...
use Sereal::Encoder 3.003_001 qw(encode_sereal sereal_encode_with_object);
use Sereal::Decoder 3.003_001 qw(decode_sereal looks_like_sereal sereal_decode_with_object);
