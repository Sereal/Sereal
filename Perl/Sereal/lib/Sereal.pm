...
use Sereal::Encoder 2.08 qw(encode_sereal sereal_encode_with_object);
use Sereal::Decoder 2.08 qw(decode_sereal looks_like_sereal sereal_decode_with_object);
